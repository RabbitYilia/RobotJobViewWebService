...
namespace RobotJobViewWebService
{
    public class ResultsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,filename,filelocalpath")] Result result)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,filename,filelocalpath")] Result result)
        {
            if (id != result.ID)
            {
                return NotFound();
